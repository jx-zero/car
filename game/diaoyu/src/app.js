var HelloWorldLayer = cc.Layer.extend({
    ctor:function () {
        ...
        self.wxData = {
            "appId": "", // 服务号可以填写appId
            "imgUrl" : 'http://mp.weixin.qq.com/s?__biz=MjM5ODM0NzY5NQ==&mid=200421765&idx=1&sn=b84cbda25c2bd70c34b7a1739579b8a9#rd/html5/diaoyu/logo.png',
            "link" : 'http://mp.weixin.qq.com/s?__biz=MjM5ODM0NzY5NQ==&mid=200421765&idx=1&sn=b84cbda25c2bd70c34b7a1739579b8a9#rd/html5/diaoyu/',
        ...
        WeixinApi.ready(function(Api) {
            ...
            var wxCallbacks = {
                ...
                confirm : function(resp) {
                    ...
                    //window.location.href='http://mp.weixin.qq.com/s?__biz=MjM5ODM0NzY5NQ==&mid=200421765&idx=1&sn=b84cbda25c2bd70c34b7a1739579b8a9#rd/';
                    // alert("分享成功");
                },
                // 整个分享过程结束
                all : function(resp) {
                    ...
                    // alert("分享结束");
                    if(self.isGameOver){
                        if(window.location) window.location.href = "http://mp.weixin.qq.com/s?__biz=MjM5ODM0NzY5NQ==&mid=200421765&idx=1&sn=b84cbda25c2bd70c34b7a1739579b8a9#rd/html5/diaoyu/";
                    }
                }
            };
    ...
    gameOver: function(){
        ...
        layerMask.delay(0.5).then(function(){
            ...
            var share = cc.createSprite('http://mp.weixin.qq.com/s?__biz=MjM5ODM0NzY5NQ==&mid=200421765&idx=1&sn=b84cbda25c2bd70c34b7a1739579b8a9#rd/html5/diaoyu/share.png', {
                anchor: [1.0, 1.0],
                xy: [720, 1280],
                opacity: 0,
                scale: 0.5
