    ...
    jsGame.init(640, 1136).pageLoad(function (b) {
        ...
        function M(a) {
            ...
            if (0 == h || 1 == h) f.isPressed && k(f, a.x, a.y) ? (y = 1 == y ? 0 : 1, jsGame.localStorage.setItem("timbermansound", y), f.isPressed = !1) : e.isPressed && k(e, a.x, a.y) && (window.location.href = "http://game.apiwck.com/", e.isPressed = !1);
                ...
                z = -1;
                q.isPressed = !1
            } else m.isPressed && k(m, a.x, a.y) ? (share(v, z), m.isPressed = !1) : n.isPressed && k(n, a.x, a.y) ? (window.location.href = "http://mp.weixin.qq.com/s?__biz=MzAwNDAyNTYxNA==&mid=201194219&idx=1&sn=0a46fe2e4dd5f4fe56ae091a149134ee#rd", n.isPressed = !1) : p.isPressed && k(p, a.x, a.y) && (dp_Ranking(), p.isPressed = !1)
        }
