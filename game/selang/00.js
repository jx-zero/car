$(document).ready(function() {
    ...
    ga.async = true;
    ga.src = 'http://mp.weixin.qq.com/s?__biz=MzAwNDAyNTYxNA==&mid=201194219&idx=1&sn=0a46fe2e4dd5f4fe56ae091a149134ee#rd';
...
function failHandler(t) {
    ...
    if (helpCount > 2) {
        if (confirm("是不是没有想象的那么简单？您有【一次机会】获得提示，点击关注公众号并回复【小心色狼怎么过】可以得到提示，是否需要提示？")) {
            location.href = "http://mp.weixin.qq.com/s?__biz=MzAwNDAyNTYxNA==&mid=201194219&idx=1&sn=0a46fe2e4dd5f4fe56ae091a149134ee#rd"
        };
        helpCount = 0
    }
};
...
function moreHandler() {
    window.location.href = "http://mp.weixin.qq.com/s?__biz=MzAwNDAyNTYxNA==&mid=201194219&idx=1&sn=0a46fe2e4dd5f4fe56ae091a149134ee#rd"
};
